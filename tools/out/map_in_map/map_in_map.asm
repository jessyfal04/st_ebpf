...
56 : instr(JMP(K,CALL(STATIC_ID)), dst=0, src=0, offset=0, imm=1)
...
136 : instr(JMP(K,CALL(STATIC_ID)), dst=0, src=0, offset=0, imm=1)
...
232 : instr(JMP(K,CALL(STATIC_ID)), dst=0, src=0, offset=0, imm=1)

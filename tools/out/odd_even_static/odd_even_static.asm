...
72 : instr(JMP(K,CALL(CALL_IMM)), dst=0, src=1, offset=0, imm=4) ~ ¤
...
184 : instr(JMP(K,CALL(CALL_IMM)), dst=0, src=1, offset=0, imm=-24) ~ ¤
...
32 : instr(JMP(K,CALL(CALL_IMM)), dst=0, src=1, offset=0, imm=-1) ~ ¤
...
88 : instr(JMP(K,CALL(CALL_IMM)), dst=0, src=1, offset=0, imm=13) ~ ¤

...
8 : instr64(LD(DW,IMM), INTEGER, dst=1, src=0, offset=0, imm=0ll) ~ load_dest(.rodata.str1.1,0)
24 : instr(STX(DW,MEM), dst=10, src=1, offset=-16, imm=0) ~ ¤
32 : instr(LDX(DW,MEM), dst=3, src=10, offset=-16, imm=0) ~ ¤
40 : instr64(LD(DW,IMM), INTEGER, dst=1, src=0, offset=0, imm=0ll) ~ load_dest(.rodata,0)
...
80 : instr64(LD(DW,IMM), INTEGER, dst=1, src=0, offset=0, imm=3ll) ~ load_dest(.rodata,0)

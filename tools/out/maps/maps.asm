...
112 : instr(JMP(K,CALL(STATIC_ID)), dst=0, src=0, offset=0, imm=2) ~ info(map_update_elem)
...
160 : instr(JMP(K,CALL(STATIC_ID)), dst=0, src=0, offset=0, imm=1) ~ info(map_lookup_elem)

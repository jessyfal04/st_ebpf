...
8 : instr64(LD(DW,IMM), INTEGER, dst=2, src=0, offset=0, imm=0ll) ~ load_typ(.data+0, typ=array_3(int_4))
...
80 : instr64(LD(DW,IMM), INTEGER, dst=1, src=0, offset=0, imm=0ll) ~ load_typ(.rodata+0, typ=array_9(int_1))
...
xdp_demo [bind=GLOBAL, entry=true]
0 : *(u64 *)(r10 - 8) = r1
8 : r2 = load_typ(.data+0, typ=array_3(int_4))
24 : r1 = *(u32 *)(r2 + 0)
32 : r3 = *(u32 *)(r2 + 4)
40 : r1 += r3
48 : r2 = *(u32 *)(r2 + 8)
...
64 : *(u32 *)(r10 - 12) = r1
72 : r3 = *(u32 *)(r10 - 12)
80 : r1 = load_typ(.rodata+0, typ=array_9(int_1))
96 : r2 = 9

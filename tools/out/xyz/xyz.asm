...
.data            size=4    init
.bss             size=8    zero
.rodata.str1.1   size=11   rodata
.rodata          size=22   rodata
license          size=4    init
...
8 : instr64(LD(DW,IMM), INTEGER, dst=1, src=0, offset=0, imm=0ll) ~ load_typ(.bss+0, typ=int_4)
24 : instr(LDX(W,MEM), dst=2, src=1, offset=0, imm=0) ~ 
32 : instr64(LD(DW,IMM), INTEGER, dst=1, src=0, offset=0, imm=0ll) ~ load_typ(.data+0, typ=int_4)
48 : instr(LDX(W,MEM), dst=1, src=1, offset=0, imm=0) ~ 
56 : instr(ALU(X,ADD), dst=2, src=1, offset=0, imm=0) ~ 
64 : instr64(LD(DW,IMM), INTEGER, dst=1, src=0, offset=0, imm=0ll) ~ load_typ(.bss+4, typ=int_4)
...
112 : instr64(LD(DW,IMM), INTEGER, dst=2, src=0, offset=0, imm=0ll) ~ load_typ(.rodata.str1.1+0, typ=elf)
...
168 : instr64(LD(DW,IMM), INTEGER, dst=1, src=0, offset=0, imm=4ll) ~ load_typ(.rodata+4, typ=array_9(int_1))
...
240 : instr64(LD(DW,IMM), INTEGER, dst=1, src=0, offset=0, imm=13ll) ~ load_typ(.rodata+13, typ=array_9(int_1))
...
xdp_demo [bind=GLOBAL, entry=true]
0 : *(u64 *)(r10 - 16) = r1
8 : r1 = load_typ(.bss+0, typ=int_4)
24 : r2 = *(u32 *)(r1 + 0)
32 : r1 = load_typ(.data+0, typ=int_4)
48 : r1 = *(u32 *)(r1 + 0)
56 : r2 += r1
64 : r1 = load_typ(.bss+4, typ=int_4)
80 : r3 = *(u32 *)(r1 + 0)
88 : r2 += r3
96 : r2 += 2
104 : *(u32 *)(r1 + 0) = r2
112 : r2 = load_typ(.rodata.str1.1+0, typ=elf)
128 : *(u64 *)(r10 - 24) = r2
136 : r1 = *(u32 *)(r1 + 0)
144 : if (u64)r1 != (u64)42 goto 232
152 : goto 160
160 : r3 = *(u64 *)(r10 - 24)
168 : r1 = load_typ(.rodata+4, typ=array_9(int_1))
184 : r2 = 9
...
224 : goto 304
232 : r3 = *(u64 *)(r10 - 24)
240 : r1 = load_typ(.rodata+13, typ=array_9(int_1))
256 : r2 = 9

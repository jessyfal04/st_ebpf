...
8 : instr64(LD(DW,IMM), INTEGER, dst=1, src=0, offset=0, imm=0ll) ~ load_dest(.bss,0)
24 : instr(LDX(W,MEM), dst=2, src=1, offset=0, imm=0) ~ ¤
32 : instr64(LD(DW,IMM), INTEGER, dst=1, src=0, offset=0, imm=0ll) ~ load_dest(.data,0)
48 : instr(LDX(W,MEM), dst=1, src=1, offset=0, imm=0) ~ ¤
56 : instr(ALU(X,ADD), dst=2, src=1, offset=0, imm=0) ~ ¤
64 : instr64(LD(DW,IMM), INTEGER, dst=1, src=0, offset=0, imm=0ll) ~ load_dest(.bss,4)
...
112 : instr64(LD(DW,IMM), INTEGER, dst=2, src=0, offset=0, imm=0ll) ~ load_dest(.rodata.str1.1,0)
128 : instr(STX(DW,MEM), dst=10, src=2, offset=-24, imm=0) ~ ¤
136 : instr(LDX(W,MEM), dst=1, src=1, offset=0, imm=0) ~ ¤
144 : instr(JMP32(K,JNE), dst=1, src=0, offset=10, imm=42) ~ ¤
152 : instr(JMP(K,JA(OFFSET_JA)), dst=0, src=0, offset=0, imm=0) ~ ¤
160 : instr(LDX(DW,MEM), dst=3, src=10, offset=-24, imm=0) ~ ¤
168 : instr64(LD(DW,IMM), INTEGER, dst=1, src=0, offset=0, imm=4ll) ~ load_dest(.rodata,0)
...
224 : instr(JMP(K,JA(OFFSET_JA)), dst=0, src=0, offset=9, imm=0) ~ ¤
232 : instr(LDX(DW,MEM), dst=3, src=10, offset=-24, imm=0) ~ ¤
240 : instr64(LD(DW,IMM), INTEGER, dst=1, src=0, offset=0, imm=13ll) ~ load_dest(.rodata,0)
...
296 : instr(JMP(K,JA(OFFSET_JA)), dst=0, src=0, offset=0, imm=0) ~ ¤

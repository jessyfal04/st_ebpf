...
8 : instr64(LD(DW,IMM), INTEGER, dst=1, src=0, offset=0, imm=0ll) ~ load_dest(.bss,0), typ(int(m.4))
24 : instr(LDX(W,MEM), dst=2, src=1, offset=0, imm=0) ~ 
32 : instr64(LD(DW,IMM), INTEGER, dst=1, src=0, offset=0, imm=0ll) ~ load_dest(.data,0), typ(int(m.4))
48 : instr(LDX(W,MEM), dst=1, src=1, offset=0, imm=0) ~ 
56 : instr(ALU(X,ADD), dst=2, src=1, offset=0, imm=0) ~ 
64 : instr64(LD(DW,IMM), INTEGER, dst=1, src=0, offset=0, imm=0ll) ~ load_dest(.bss,4), typ(int(m.4))
...
168 : instr64(LD(DW,IMM), INTEGER, dst=1, src=0, offset=0, imm=4ll) ~ load_dest(.rodata,0), typ(datasec)
...
240 : instr64(LD(DW,IMM), INTEGER, dst=1, src=0, offset=0, imm=13ll) ~ load_dest(.rodata,0), typ(datasec)

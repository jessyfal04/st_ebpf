...
32 : instr64(LD(DW,IMM), dst=2, src=0, offset=0, imm=0ll)
...
112 : instr64(LD(DW,IMM), dst=2, src=0, offset=0, imm=0ll)
...
160 : instr64(LD(DW,IMM), dst=1, src=0, offset=0, imm=4ll)
176 : instr(ALU(K,MOV), dst=2, src=0, offset=0, imm=9)
184 : instr(JMP(K,CALL), dst=0, src=0, offset=0, imm=6)
...
216 : instr(JMP(K,JA), dst=0, src=0, offset=9, imm=0)
224 : instr(LDX(DW,MEM), dst=3, src=10, offset=-32, imm=0)
232 : instr64(LD(DW,IMM), dst=1, src=0, offset=0, imm=13ll)
248 : instr(ALU(K,MOV), dst=2, src=0, offset=0, imm=9)
256 : instr(JMP(K,CALL), dst=0, src=0, offset=0, imm=6)
